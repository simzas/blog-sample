        ...
        <div className="py-4 md:min-w-[600px] md:max-w-5xl">
            <div className="bg-slate-900 rounded border border-slate-700
                ...
                <div className="p-4 first-letter:uppercase">
                    <span className='w-max'>Placeholder text so you can read something while this page is loading for you. Gimme lil moment please, thanks for your patience!</span>
                </div>
            </div>
        </div>
    )
